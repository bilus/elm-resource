...
* TODO Manager can resize a reservation to change its time
** DONE Draw resize handles
   CLOSED: [2019-07-19 Fri 22:39]
** DONE Try to use elm-ui-dragdrop
   CLOSED: [2019-07-22 Mon 12:15]
** TODO Make a segment handle draggable to see how it looks like
** TODO Resize segment as its handle is being dragged
** TODO Break up segments into e.g. 30 minute sub-segments
